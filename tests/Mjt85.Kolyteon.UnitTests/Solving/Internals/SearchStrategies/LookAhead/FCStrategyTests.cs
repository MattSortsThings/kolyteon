...
/// <summary>
///     Unit tests for the internal <see cref="FCStrategy{V,D}" /> class, parametrized over the Map Colouring problem
///     types.
/// </summary>
public class FCStrategyTests
{
    ...
    private static Mock<IOrderingStrategy> MockOrderingStrategyThatNeverReorders()
    {
        ...
        mock.Setup(m => m.GetLevelOfOptimalNode(It.IsAny<IList<FCNode<Region, Colour>>>(), It.IsAny<int>()))
            .Returns((IList<FCNode<Region, Colour>> _, int searchLevel) => searchLevel);
    ...
    {
        [Fact]
        public void Is_ForwardChecking_SearchEnumValue()
        {
            // Arrange
            FCStrategy<Region, Colour> sut = new(0);

            // Assert
            sut.Identifier.Should().Be(Search.ForwardChecking);
        }
    }
    ...
    public sealed class StateTransitions
    {
        ...
        {
            // Arrange
            FCStrategy<Region, Colour> sut = new(3);
            ...
            using (new AssertionScope())
            {
                ...
                sut.SearchTree.Should().SatisfyRespectively(at0 =>
                    ...
                    }, at1 =>
                    {
                        ...
                        at1.BacktrackLevel.Should().Be(0);
                        at1.DomainValueIndex.Should().Be(-1);
                        at1.Candidates.Should().Equal(0, 1, 2);
                        at1.RejectedCandidates.Should().BeEmpty();
                        at1.Successors.Should().BeEmpty();
                        at1.PruningMemos.Should().BeEmpty();
                    },
                ...
                sut.SearchTree.Should().SatisfyRespectively(at0 =>
                    {
                        ...
                        at0.PruningMemos.Should().SatisfyRespectively(first =>
                        {
                            ...
                            first.PrunedCandidate.Should().Be(2);
                        });
                    }, at1 =>
                    {
                        at1.VariableIndex.Should().Be(1);
        ...
        public void StateIsUnsafe_BacktrackInvoked_SearchLevelIsEarlierNonLeafLevel_CandidatesNotExhausted_StateIsSafe()
        {
            ...
            using (new AssertionScope())
            {
                ...
                sut.SearchTree.Should().SatisfyRespectively(at0 =>
                {
                    ...
                    {
                        second.PrunedNode.VariableIndex.Should().Be(2);
                        second.PrunedCandidate.Should().Be(0);
                    });
                }, at1 =>
                {
                    at1.VariableIndex.Should().Be(1);
                    ...
                    at1.DomainValueIndex.Should().Be(-1);
                    at1.Candidates.Should().BeEmpty();
                    at1.RejectedCandidates.Should().Equal(1);
    ...
    public sealed class GetAssignments_Method
    {
        ...
        {
            // Arrange
            FCStrategy<Region, Colour> sut = new(1);
