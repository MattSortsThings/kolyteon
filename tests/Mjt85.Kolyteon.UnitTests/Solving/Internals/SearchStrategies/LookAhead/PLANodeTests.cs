...
/// <summary>
///     Unit tests for the internal <see cref="PLANode{V,D}" /> class, parametrized over the Map Colouring problem types.
/// </summary>
public sealed class PLANodeTests
{
    ...
    public sealed class Candidates_Property
    {
        ...
        {
            // Arrange
            PLANode<Region, Colour> sut = GetNode()
    ...
    public sealed class AdjacentTo_Method
    {
        ...
        public void InstanceAndOtherHaveAdjacentVariables_ReturnsTrue()
        {
            ...
            PLANode<Region, Colour> nodeAt0 = GetNode().WithBinaryCsp(binaryCsp).WithVariableIndex(0).Build();
            PLANode<Region, Colour> nodeAt1 = GetNode().WithBinaryCsp(binaryCsp).WithVariableIndex(1).Build();
    ...
    public sealed class AssignNextCandidate_Method
    {
        ...
        {
            // Arrange
            PLANode<Region, Colour> sut = GetNode().WithBinaryCsp(GetBinaryCsp.ModellingProblem(MapColouringPuzzle.Create()
                    .WithGlobalColours(Colour.Black, Colour.White)
                    .AddRegion(R0)
                    .Build()))
                .WithVariableIndex(0)
    ...
    public sealed class RepopulateSuccessors_Method
    {
        ...
        public void AddsAllAdjacentNodesAtLaterSearchTreeLevelsToAncestors_OrderedBySearchTreeLevel()
        {
            ...
            PLANode<Region, Colour> nodeAt0 = GetNode().WithBinaryCsp(binaryCsp).WithVariableIndex(0).Build();
            PLANode<Region, Colour> nodeAt1 = GetNode().WithBinaryCsp(binaryCsp).WithVariableIndex(1).Build();
            PLANode<Region, Colour> nodeAt2 = GetNode().WithBinaryCsp(binaryCsp).WithVariableIndex(2).Build();
            PLANode<Region, Colour> nodeAt3 = GetNode().WithBinaryCsp(binaryCsp).WithVariableIndex(3).Build();
            PLANode<Region, Colour> nodeAt4 = GetNode().WithBinaryCsp(binaryCsp).WithVariableIndex(4).Build();

            PLANode<Region, Colour>[] searchTree = [nodeAt0, nodeAt1, nodeAt2, nodeAt3, nodeAt4];
    ...
    public sealed class Prune_Method
    {
        ...
        public void PrunesAllOperandNodeCandidatesNotSupportedByInstanceAssignment_AddsPruningMemoForEach()
        {
            ...
            PLANode<Region, Colour> sut = GetNode().WithBinaryCsp(binaryCsp).WithVariableIndex(0).Build();
            PLANode<Region, Colour> operand = GetNode().WithBinaryCsp(binaryCsp).WithVariableIndex(1).Build();
    ...
    public sealed class UndoAllPruning_Method
    {
        ...
        public void EnqueuesAllPrunedCandidatesToPrunedNodes_ClearsPruningMemos()
        {
            ...
            PLANode<Region, Colour> sut = GetNode().WithBinaryCsp(binaryCsp).WithVariableIndex(0).Build();
            PLANode<Region, Colour> operandAt1 = GetNode().WithBinaryCsp(binaryCsp).WithVariableIndex(1).Build();
            PLANode<Region, Colour> operandAt2 = GetNode().WithBinaryCsp(binaryCsp).WithVariableIndex(2).Build();
    ...
    public sealed class CandidateSupports_Method
    {
        ...
        public void InstanceHasAtLeastOneCandidateSupportingOtherAssignment_ReturnsTrue()
        {
            ...
            PLANode<Region, Colour> sut = GetNode().WithBinaryCsp(binaryCsp).WithVariableIndex(0).Build();
            PLANode<Region, Colour> other = GetNode().WithBinaryCsp(binaryCsp).WithVariableIndex(1).Build();
