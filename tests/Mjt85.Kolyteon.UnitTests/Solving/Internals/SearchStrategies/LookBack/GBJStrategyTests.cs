...
/// </summary>
public sealed class GBJStrategyTests
{
    ...
    private static Mock<IOrderingStrategy> MockOrderingStrategyThatNeverReorders()
    {
        ...
        mock.Setup(m => m.GetLevelOfOptimalNode(It.IsAny<IList<GBJNode<Region, Colour>>>(), It.IsAny<int>()))
    ...
    {
        [Fact]
        public void Is_GraphBasedBackjumping_SearchEnumValue()
        {
            // Arrange
            GBJStrategy<Region, Colour> sut = new(0);

            // Assert
            sut.Identifier.Should().Be(Search.GraphBasedBackjumping);
        }
    }
    ...
    public sealed class EnsureCapacity_Method
    {
        ...
        public void CapacityArgIsGreaterThanInstanceCapacity_UpdatesCapacity(int revisedCapacity)
        {
            ...
            GBJStrategy<Region, Colour> sut = new(initialCapacity);
    ...
    public sealed class StateTransitions
    {
        ...
        {
            // Arrange
            GBJStrategy<Region, Colour> sut = new(3);
            ...
            using (new AssertionScope())
            {
                ...
                sut.SearchTree.Should().SatisfyRespectively(at0 =>
                {
                    ...
                    at0.InducedAncestorLevels.Should().BeEmpty();
                }, at1 =>
                {
                    ...
                    at1.InducedAncestorLevels.Should().BeEmpty();
                });
            }
        }
        ...
        public void StateIsSafe_VisitInvoked_AssignmentMade_SearchLevelIsNextNonLeafLevel_StateIsSafe()
        {
            ...
            using (new AssertionScope())
            {
                ...
                }, at1 =>
                {
                    ...
                    at1.InducedAncestorLevels.Should().Equal(0);
                });
            }
        }
        ...
        public void StateIsSafe_VisitInvoked_AssignmentMade_SearchLevelIsLeafLevel_StateIsFinal()
        {
            ...
            using (new AssertionScope())
            {
                ...
                }, at2 =>
                {
                    ...
                    at2.InducedAncestorLevels.Should().BeEquivalentTo([0, 1]);
                });
            }
        ...
        public void StateIsUnsafe_BacktrackInvoked_SearchLevelIsEarlierNonLeafLevel_CandidatesNotExhausted_StateIsSafe()
        {
            ...
            using (new AssertionScope())
            {
                ...
                mockOrderingStrategy.Verify(m => m.GetLevelOfOptimalNode(sut.SearchTree, 2), Times.Once);
                mockOrderingStrategy.VerifyNoOtherCalls();
                sut.SearchTree.Should().SatisfyRespectively(at0 =>
                {
                    at0.VariableIndex.Should().Be(0);
            ...
            using (new AssertionScope())
            {
                ...
                }, at2 =>
                {
                    ...
                    at2.InducedAncestorLevels.Should().BeEmpty();
                });
            }
        }
    ...
    public sealed class GetAssignments_Method
    {
        ...
        {
            // Arrange
            GBJStrategy<Region, Colour> sut = new(1);
