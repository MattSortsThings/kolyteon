...
public class MapColouringDegreeStatistics : TheoryData<MapColouringPuzzle, DegreeStatistics>
{
    public MapColouringDegreeStatistics()
    {
        ...
        Add(MapColouringPuzzle.Create()
            ...
            .Build(), new DegreeStatistics
        {
            MinimumValue = 0, MeanValue = 2.571429, MaximumValue = 5, DistinctValues = 4
        });
