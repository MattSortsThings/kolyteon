...
public sealed class MapColouringAdjacentVariables : TheoryData<MapColouringPuzzle, IEnumerable<Pair<Region>>>
{
    public MapColouringAdjacentVariables()
    {
        ...
        Add(MapColouringPuzzle.Create()
            ...
            .AddRegionWithColours(X1, Colour.Black, Colour.White)
            .AddRegionWithColours(X2, Colour.Black)
            .AddRegionWithColours(X3, Colour.DarkMagenta)
            .AddRegionWithColours(X4, Colour.Black, Colour.DarkMagenta)
            .SetAsNeighbours(X1, X2)
            .SetAsNeighbours(X2, X3)
            .SetAsNeighbours(X3, X4)
            .SetAsNeighbours(X4, X1)
            .Build(), [
            new Pair<Region>(X1, X2),
            new Pair<Region>(X1, X4),
            new Pair<Region>(X3, X4)
        ]);
        ...
        Add(MapColouringPuzzle.Create()
            ...
            .Build(), [
            new Pair<Region>(X1, X2),
            new Pair<Region>(X1, X3),
            new Pair<Region>(X1, X4),
            new Pair<Region>(X1, X7),
            new Pair<Region>(X2, X6),
            new Pair<Region>(X3, X7),
            new Pair<Region>(X4, X5),
            new Pair<Region>(X4, X7),
            new Pair<Region>(X5, X6),
            new Pair<Region>(X5, X7)
        ]);
    }
}
