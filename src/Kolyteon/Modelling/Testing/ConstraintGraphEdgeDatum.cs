...
public sealed record ConstraintGraphEdgeDatum<TVariable, TDomainValue>
    ...
    where TDomainValue : struct, IComparable<TDomainValue>, IEquatable<TDomainValue>
{
    ...
    /// <summary>
    ///     Indicates whether this <see cref="ConstraintGraphEdgeDatum{TVariable,TDomainValue}" /> instance has equal value to
    ///     another instance of the same type.
    /// </summary>
    /// <remarks>
    ///     Two <see cref="ConstraintGraphEdgeDatum{TVariable,TDomainValue}" /> instances have equal value if their
    ...
    /// </remarks>
    /// <param name="other">
    ///     The <see cref="ConstraintGraphEdgeDatum{TVariable,TDomainValue}" /> instance against which this instance
    ///     is to be compared.
    /// </param>
    /// <returns>
    ...
    /// </returns>
    public bool Equals(ConstraintGraphEdgeDatum<TVariable, TDomainValue>? other)
    {
        if (other is null)
        {
            return false;
    ...
    /// <summary>
    ///     Returns the hash code for this <see cref="ConstraintGraphEdgeDatum{TVariable,TDomainValue}" /> instance.
    /// </summary>
