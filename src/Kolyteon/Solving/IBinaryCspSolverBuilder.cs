...
public interface IBinaryCspSolverBuilder<TVariable, TDomainValue>
    where TVariable : struct, IComparable<TVariable>, IEquatable<TVariable>
    where TDomainValue : struct, IComparable<TDomainValue>, IEquatable<TDomainValue>
{
    /// <summary>
    ///     Sets the initial <see cref="BinaryCspSolver{TVariable,TDomainValue}.Capacity" /> of the new
    ///     <see cref="BinaryCspSolver{TVariable,TDomainValue}" /> instance.
    /// </summary>
    /// <param name="capacity">
    ///     A non-negative integer. The number of binary CSP variables that the binary CSP solver's internal
    ///     data structures can accommodate without resizing.
    /// </param>
    ...
    {
        /// <summary>
        ///     Sets the initial <see cref="BinaryCspSolver{TVariable,TDomainValue}.CheckingStrategy" /> of the new
        ///     <see cref="BinaryCspSolver{TVariable,TDomainValue}" /> instance.
        /// </summary>
        /// <param name="checkingStrategy">
        ///     Specifies the initial checking strategy component of the backtracking search algorithm
        ///     used by the binary CSP solver.
        /// </param>
        /// <returns>The same fluent builder instance, so that method invocations can be chained.</returns>
    ...
    {
        /// <summary>
        ///     Sets the initial <see cref="BinaryCspSolver{TVariable,TDomainValue}.OrderingStrategy" /> of the new
        ///     <see cref="BinaryCspSolver{TVariable,TDomainValue}" /> instance.
        /// </summary>
        /// <param name="orderingStrategy">
        ///     Specifies the initial ordering strategy component of the backtracking search algorithm
        ///     used by the binary CSP solver.
        /// </param>
        /// <returns>The same fluent builder instance, so that method invocations can be chained.</returns>
    ...
    {
        /// <summary>
        ///     Creates and returns a new <see cref="BinaryCspSolver{TVariable,TDomainValue}" /> instance as specified by all the
        ///     previous fluent builder method invocations.
        /// </summary>
        /// <returns>A new <see cref="BinaryCspSolver{TVariable,TDomainValue}" /> instance.</returns>
