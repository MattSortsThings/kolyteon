...
{
    /// <summary>
    ///     Sets the initial <see cref="VerboseBinaryCspSolver{TVariable,TDomainValue}.Capacity" /> of the new
    ...
    {
        /// <summary>
        ///     Sets the initial <see cref="VerboseBinaryCspSolver{TVariable,TDomainValue}.CheckingStrategy" /> of the new
        ///     <see cref="VerboseBinaryCspSolver{TVariable,TDomainValue}" /> instance.
        /// </summary>
    ...
    {
        /// <summary>
        ///     Sets the initial <see cref="VerboseBinaryCspSolver{TVariable,TDomainValue}.OrderingStrategy" /> of the new
        ///     <see cref="VerboseBinaryCspSolver{TVariable,TDomainValue}" /> instance.
        /// </summary>
