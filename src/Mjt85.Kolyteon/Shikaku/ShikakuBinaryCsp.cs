...
public sealed class ShikakuBinaryCsp : BinaryCsp<ShikakuPuzzle, Hint, Rectangle>
{
    ...
    /// <inheritdoc />
    /// <remarks>
    ///     In the Shikaku binary CSP model, there is a notional binary constraint for every pair of hints. The constraint
    ///     has a binary predicate that asserts that the two hints must be assigned non-overlapping rectangles.
    /// </remarks>
